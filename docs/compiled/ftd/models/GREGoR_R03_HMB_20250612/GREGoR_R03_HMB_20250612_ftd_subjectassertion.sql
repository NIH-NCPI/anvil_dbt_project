    ...
    with source as (
       ...
       'sa' || '_' || md5('GREGoR_R03_HMB_20250612' || '|' || cast(coalesce(participant.participant_id, '') as text))::text as "id",
       'sb' || '_' || md5('GREGoR_R03_HMB_20250612' || '|' || cast(coalesce(phenotype.participant_id, '') as text))::text as "Subject_id"
