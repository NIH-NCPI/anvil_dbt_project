...
3. Start an environment. Put the gsutil URI of the startup script into the startup script field and start the env. This will take several minutes.
4. Place anvil_dbt_project/scripts/harmonization_initial_setup.py in the 'home/jupyter'
5. Place your id_rsa key in the 'home/jupyter' dir
...
8. Run setup_ssh
9. Run clone_repo - When asked, answer 'yes'
10. Run setup_data

## Pipeline setup
1. Fill out config file(s)
