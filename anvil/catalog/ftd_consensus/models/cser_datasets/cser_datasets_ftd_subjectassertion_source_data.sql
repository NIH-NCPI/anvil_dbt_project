...
select 
  {{ generate_global_id(prefix='',descriptor=[''], study_id='cser_datasets') }}::text as "subjectassertion_id",
    {{ generate_global_id(prefix='',descriptor=[''], study_id='cser_datasets') }}::text as "source_data_id"
