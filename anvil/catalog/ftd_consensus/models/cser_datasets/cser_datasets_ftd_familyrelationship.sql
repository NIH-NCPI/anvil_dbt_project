...
select 
  {{ generate_global_id(prefix='',descriptor=[''], study_id='cser_datasets') }}::text as "family_member",
    {{ generate_global_id(prefix='',descriptor=[''], study_id='cser_datasets') }}::text as "other_family_member",
