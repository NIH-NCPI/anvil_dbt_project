{{ config(materialized='table', schema='GREGoR_R01_HMB_20240208_data') }}
    ...
    with source as (
       ...
       {{ generate_global_id(prefix='sa',descriptor=['participant.participant_id'], study_id='GREGoR_R01_HMB_20240208') }}::text as "id",
       {{ generate_global_id(prefix='sb',descriptor=['phenotype.participant_id'], study_id='GREGoR_R01_HMB_20240208') }}::text as "Subject_id"
...
on participant.participant_id = phenotype.participant_id 
    ...
    --     from {{ ref('GREGoR_R01_HMB_20240208_ftd_accesspolicy') }}
    -- )
