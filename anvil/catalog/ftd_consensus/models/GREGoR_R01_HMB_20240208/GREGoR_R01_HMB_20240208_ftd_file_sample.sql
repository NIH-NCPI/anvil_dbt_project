{{ config(materialized='table', schema='GREGoR_R01_HMB_20240208_data') }}
    ...
    with source as (
        select 
        {{ generate_global_id(prefix='',descriptor=[''], study_id='GREGoR_R01_HMB_20240208') }}::text as "file_id",
       {{ generate_global_id(prefix='',descriptor=[''], study_id='GREGoR_R01_HMB_20240208') }}::text as "sample_id"
