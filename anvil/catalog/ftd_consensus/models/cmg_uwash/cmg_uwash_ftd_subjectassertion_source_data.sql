...
select 
  {{ generate_global_id(prefix='',descriptor=[''], study_id='cmg_uwash') }}::text as "subjectassertion_id",
    {{ generate_global_id(prefix='',descriptor=[''], study_id='cmg_uwash') }}::text as "source_data_id"
