...
select 
  {{ generate_global_id(prefix='',descriptor=[''], study_id='cmg_uwash') }}::text as "parent_sample",
  ...
  GEN_UNKNOWN.quantity_units::text as "quantity_units",
    ...
    {{ generate_global_id(prefix='',descriptor=[''], study_id='cmg_uwash') }}::text as "biospecimen_collection_id"
