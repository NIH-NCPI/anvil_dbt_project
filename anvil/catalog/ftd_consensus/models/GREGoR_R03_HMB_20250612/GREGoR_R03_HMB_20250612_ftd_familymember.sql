{{ config(materialized='table', schema='GREGoR_R03_HMB_20250612_data') }}
    ...
    with source as (
        select 
        {{ generate_global_id(prefix='fm',descriptor=['participant.participant_id'], study_id='GREGoR_R03_HMB_20250612') }}::text as "family_member",
        ...
        {{ generate_global_id(prefix='fm',descriptor=['participant.participant_id'], study_id='GREGoR_R03_HMB_20250612') }}::text as "id",
       {{ generate_global_id(prefix='fm',descriptor=['participant.family_id'], study_id='GREGoR_R03_HMB_20250612') }}::text as "family_id"
