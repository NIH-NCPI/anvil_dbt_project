...
select 
  {{ generate_global_id(prefix='',descriptor=[''], study_id='PGRNseq') }}::text as "family_member",
    {{ generate_global_id(prefix='',descriptor=[''], study_id='PGRNseq') }}::text as "other_family_member",
