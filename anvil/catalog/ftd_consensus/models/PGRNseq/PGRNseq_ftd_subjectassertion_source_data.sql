...
select 
  {{ generate_global_id(prefix='',descriptor=[''], study_id='PGRNseq') }}::text as "subjectassertion_id",
    {{ generate_global_id(prefix='',descriptor=[''], study_id='PGRNseq') }}::text as "source_data_id"
