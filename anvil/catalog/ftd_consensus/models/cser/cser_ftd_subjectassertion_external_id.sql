...
with hpo_codes as (
    ...
    from (select distinct subject_id, consent_id, hpo_present from {{ ref('cser_stg_subject') }}) as hp
    ...
    from (select distinct subject_id, consent_id, hpo_absent from {{ ref('cser_stg_subject') }}) as ha
)
