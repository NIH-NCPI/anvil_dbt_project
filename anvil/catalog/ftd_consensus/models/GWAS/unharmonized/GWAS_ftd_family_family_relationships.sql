...
select 
  {{ generate_global_id(prefix='',descriptor=[''], study_id='GWAS') }}::text as "family_id",
    {{ generate_global_id(prefix='',descriptor=[''], study_id='GWAS') }}::text as "family_relationships_id"
